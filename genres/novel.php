...
$totalSearchResults = "SELECT COUNT(*) as total FROM books WHERE (book_genres LIKE '%novel%') OR (book_genres LIKE '%роман%')";
...
$sqlSearch = "SELECT * FROM books WHERE (book_genres LIKE '%novel%') OR (book_genres LIKE '%роман%') LIMIT $offset,$resultsPerPage";
