...
$totalSearchResults = "SELECT COUNT(*) as total FROM books WHERE (book_genres LIKE '%textbook%') OR (book_genres LIKE '%учебники%')";
...
$sqlSearch = "SELECT * FROM books WHERE (book_genres LIKE '%textbook%') OR (book_genres LIKE '%учебники%') LIMIT $offset,$resultsPerPage";
