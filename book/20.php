...
$downloadsQ = "SELECT book_downloads FROM books WHERE id = 20 ;";
...
echo "<body>
    ...
    echo " <img src= '../images/";
    print_r("ВедьмакПоследнееЖелание.jpg");
    echo " ' alt='bookCover'>";
    ?>
    <?php
    if ($_SESSION["logged_in"]) {
    echo " <a href=";
    print_r("/kursach/book/bookFiles/Последнее_Желание.fb2");
    ...
    print_r("ГЕРАЛЬТ И ЛЮТИК всего лишь хотели порыбачить, но случайно освободили джинна запертого в кувшине. Беспечный Лютик начинает загадывать желания, однако, вместо того чтобы исполнять их, джин внезапно набрасывается на него.
