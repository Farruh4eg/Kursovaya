...
$downloadsQ = "SELECT book_downloads FROM books WHERE id = 9 ;";
...
echo "<body>
    ...
    echo " <img src= '../images/";
    print_r("HereticsOfDune.jpg");
    echo " ' alt='bookCover'>";
    ?>
    <?php
    if ($_SESSION["logged_in"]) {
    echo " <a href=";
    print_r("/kursach/book/bookFiles/Heretics_of_Dune.epub");
