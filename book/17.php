...
$downloadsQ = "SELECT book_downloads FROM books WHERE id = 17 ;";
...
echo "<body>
    ...
    echo " <a href=";
    print_r("/kursach/book/bookFiles/Jaws.epub");
