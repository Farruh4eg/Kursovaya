...
$downloadsQ = "SELECT book_downloads FROM books WHERE id = 19 ;";
...
echo "<body>
    ...
    echo " <img src= '../images/";
    print_r("Собачье_Сердце.jpg");
    echo " ' alt='bookCover'>";
    ?>
    <?php
    if ($_SESSION["logged_in"]) {
    echo " <a href=";
    print_r("/kursach/book/bookFiles/Собачье_Сердце.epub");
    ...
    print_r(" 'Собачье сердце' Михаила Булгакова - это ироническая сатира на людей, стремящихся изменить свою природу. Главный герой - профессор Филипп Филиппович Премудрый - превращает бездомную собаку Шарика в человека, в результате чего Шарик получает ум и голос, но остается с внешностью собаки. Шарик-человек становится протеже Преображенского института, который проводит над ним эксперименты. ");
    echo "</p>";
