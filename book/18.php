...
$downloadsQ = "SELECT book_downloads FROM books WHERE id = 18 ;";
...
<head>
    ...
    <title>";
    print_r("C++ Primer Plus (sixth edition)");
    echo "</title>
...
echo "<body>
    ...
    echo " <img src= '../images/";
    print_r("CPPPrimerPlus.jpg");
    echo " ' alt='bookCover'>";
    ?>
    <?php
    if ($_SESSION["logged_in"]) {
    echo " <a href=";
    print_r("/kursach/book/bookFiles/CPP_Primer_Plus.pdf");
