...
$downloadsQ = "SELECT book_downloads FROM books WHERE id = 15 ;";
...
echo "<body>
    ...
    echo " <a href=";
    print_r("/kursach/book/bookFiles/1984.epub");
    ...
    print_r("fiction, novel, фантастика, роман");
    echo "</p>";
    echo "</div>";
    echo "</div> ";
