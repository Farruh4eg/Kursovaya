...
$downloadsQ = "SELECT book_downloads FROM books WHERE id = 11 ;";
...
<head>
    ...
    <title>";
    print_r("Harry Potter and the Prisoner of Azkaban");
    echo "</title>
...
echo "<body>
    ...
    echo " <img src= '../images/";
    print_r("HarryPotterAndThePrisonerOfAzkaban.jpg");
    echo " ' alt='bookCover'>";
    ?>
    <?php
    if ($_SESSION["logged_in"]) {
    echo " <a href=";
    print_r("/kursach/book/bookFiles/Harry_Potter_And_the_Prisoner_of_Azkaban.pdf");
    ...
    print_r(" fantasy, adventures,  novel, фантастика, приключения, роман");
    echo "</p>";
    echo "</div>";
    echo "</div> ";
    ...
    print_r("Harry Potter, along with his best friends, Ron and Hermione, is about to start his third year at Hogwarts School of Witchcraft and Wizardry. Harry can't wait to get back to school after the summer holidays. (Who wouldn't if they lived with the horrible Dursleys?) But when Harry gets to Hogwarts, the atmosphere is tense. There's an escaped mass murderer on the loose, and the sinister prison guards of Azkaban have been called in to guard the school...");
    echo "</p>";
