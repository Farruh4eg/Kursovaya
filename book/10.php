...
$downloadsQ = "SELECT book_downloads FROM books WHERE id = 10 ;";
...
<head>
    ...
    <title>";
    print_r("Harry Potter and the Chamber of Secrets");
    echo "</title>
...
echo "<body>
    ...
    echo " <img src= '../images/";
    print_r("HarryPotterAndTheChamberOfSecrets.jpg");
    echo " ' alt='bookCover'>";
    ?>
    <?php
    if ($_SESSION["logged_in"]) {
    echo " <a href=";
    print_r("/kursach/book/bookFiles/Harry_Potter_And_the_Chamber_of_Secrets.pdf");
