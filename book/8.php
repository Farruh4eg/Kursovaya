...
$downloadsQ = "SELECT book_downloads FROM books WHERE id = 8 ;";
...
echo "<body>
    ...
    echo " <img src= '../images/";
    print_r("GodEmperorOfDune.jpg");
    echo " ' alt='bookCover'>";
    ?>
    <?php
    if ($_SESSION["logged_in"]) {
    echo " <a href=";
    print_r("/kursach/book/bookFiles/God_Emperor_of_Dune.epub");
