...
$downloadsQ = "SELECT book_downloads FROM books WHERE id = 12 ;";
...
<head>
    ...
    <title>";
    print_r("Harry Potter and the Goblet of Fire");
    echo "</title>
...
echo "<body>
    ...
    echo " <img src= '../images/";
    print_r("HarryPotterAndTheGobletOfFire.jpg");
    echo " ' alt='bookCover'>";
    ?>
    <?php
    if ($_SESSION["logged_in"]) {
    echo " <a href=";
    print_r("/kursach/book/bookFiles/Harry_Potter_And_the_Goblet_of_Fire.pdf");
    ...
    print_r("It is the summer holidays and soon Harry Potter will be starting his fourth year at Hogwarts School of Witchcraft and Wizardry. Harry is counting the days: there are new spells to be learnt, more Quidditch to be played, and Hogwarts castle to continue exploring. But Harry needs to be careful - there are unexpected dangers lurking...");
    echo "</p>";
